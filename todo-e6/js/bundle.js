...
_react2['default'].render(_react2['default'].createElement(_componentsTodo2['default'], null), document.body);

},{"./components/Todo":2,"react":177}],2:[function(require,module,exports){
'use strict';
...
var Todo = (function (_React$Component) {
	...
	_createClass(Todo, [{
		...
		value: function submitTodo(e) {
			...
			var todoValue = _reactAddons2['default'].findDOMNode(this.refs.todoValue);
		...
		value: function render() {
			...
			return _reactAddons2['default'].createElement(
				...
				_reactAddons2['default'].createElement(
					'form',
					{ onSubmit: this.submitTodo.bind(this) },
					_reactAddons2['default'].createElement('input', { onChange: this.onChange.bind(this), ref: 'todoValue', type: 'text', value: this.state.todoValue }),
					_reactAddons2['default'].createElement(
						'button',
						null,
						'POST'
				...
				_reactAddons2['default'].createElement(_TodoLists2['default'], { items: this.state.items })
			);
		}
	}]);
...
},{"./TodoLists":3,"react/addons":5}],3:[function(require,module,exports){
'use strict';
...
var TodoLists = (function (_React$Component) {
    function TodoLists(props) {
        _classCallCheck(this, TodoLists);

        _get(Object.getPrototypeOf(TodoLists.prototype), 'constructor', this).call(this, props);
        this.state = { items: props.items };
    }

    _inherits(TodoLists, _React$Component);
    ...
    _createClass(TodoLists, [{
        ...
        value: function render() {
            ...
            var displayFunctions = function displayFunctions() {
...
},{"./emptyFunction":134,"_process":4}],177:[function(require,module,exports){
